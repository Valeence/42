...
/*   Updated: 2025/02/05 15:30:25 by vandre           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const ClapTrap &cpy)
{
	...
	_energy = cpy._energy;
	_attack = cpy._attack;
	std::cout << "ClapTrap " << _name << " create by copy" << std::endl;
}
...
ClapTrap &ClapTrap::operator= (const ClapTrap &cpy)
{
	...
	std::cout << "ClapTrap " << _name << " create by operator" << std::endl;
	return *this;
}
...
{    
    ...
    {
        this->_hit = 0;
        std::cout << "ClapTrap : (" << this->_name << "), TAKE " << amount << ", points of damages so he died" << std::endl;
        return;
    }
    else
    {   
...
void ClapTrap::beRepaired(unsigned int amount)
{
    if (this->_hit > 0)
    {
        this->_energy -= 1;
        this->_hit += amount;
        std::cout << "ClapTrap : (" << this->_name << "), repaired " << amount << ", points of life, he a " << this->_hit << " life points"<< std::endl;
